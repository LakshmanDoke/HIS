...
<script src="/resources/js/ajaxemailvalforplancreation.js"></script>
...
<body onload="myFunction()">
	...
	<section id="account" class="section-padding">
		<h1>
			<font color="white">Application For Health Plan</font>
		</h1>
		...
		<div class="bg-agile">
			<div class="book-appointment">
				...
				<form:form action="saveapplicationofplan" method="post"
					modelAttribute="applicationforplan">
					...
					<div class="right-agileinfo same">
						...
						<div class="gaps">
							<p>SSN No</p>
							<form:input path="ssnNo" required="true" maxlength="9"
								pattern="[0-9]{9}" title="Nine letter Numeric  ssn code" />
						</div>
						<div class="gaps">
							<p>Mobile No</p>
